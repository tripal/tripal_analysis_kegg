  ...
  if (count($results_v0_3)>0) {
    ...
    if ($feature->cvname != 'gene' and count($results) > 0) { 
      ...
      foreach ($results as $analysis_id => $analysisprops) { 
        ...
        <div id="tripal_feature-kegg_results_<?php print $i?>-box" class="tripal_feature_kegg-box tripal-info-box">
          ...
          <table id="tripal_feature-kegg_summary-<?php $i ?>-table" class="tripal_analysis_kegg-summary-table tripal-table tripal-table-horz"> <?php 
            $j=0;
   ...
   <div id="tripal_feature-kegg-box" class="tripal_feature-box tripal-info-box">
     ...
     if($results['PATH']){
        ...
        <div class="tripal-no-results">There are no KEGG pathways for this feature</div> <?php 
     } ?>
     <br><br>
     ...
     if($results['KO']){
        ...
        <div class="tripal-no-results">There are no KEGG orthologs for this feature</div> <?php 
     } ?>
     <br><br>
     ...
     if($results['MODULE']){
        ...
        <div class="tripal-no-results">There are no KEGG modules for this feature</div><?php
     } ?>
   </div> <?php 
  }
}
